...
class FreezeProfile extends React.Component{
    constructor(props){
        super(props)
        this.state = {
    ...
    handleSubmit = (values) => {
        ...
        const body = {
            ...
            freezeReason: values.freezeReason,
            endDate: this.state.freezeEndDate,
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                Axios.put(`https://fittzee-backend.herokuapp.com/customer/freeze/${this.state.id}`, body, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('tokn')}` 
                    } 
                })  
        ...
        return(
            <div className="content">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem><Link to='/admin/freeze/'>Freeze</Link></BreadcrumbItem>
                ...
                <div>
                    <Row>
                        ...
                        <Col md={6}>
                            <Card>
                                <CardHeader>
                                    <h6>Freezing Details</h6>
                                </CardHeader>
                                <CardBody className="my-3">
                                    <LocalForm id="freeze-form" onSubmit={(values) => this.handleSubmit(values)}>
                                        <Row className="form-group mb-3">
                                            <Label md={2} style={{fontSize:"1.23em"}}>Days:</Label>  
                                            <Col md={3}>
                                                <Control.text type="number" model=".freezeDays" id="freezeDays" name="freezeDays"
                                                    placeholder="No.of days to freeze"   
                                                    className="form-control"   
                                                    onChange= {this.endDateChange}  
                                                    disabled={this.state.data.packages && this.state.data.payments? false: true} 
                                                    validators={{
                                                        isNumber
                                                    }}                                          
                                                />
                                            ...
                                            <Col>
                                                <Control.text model=".endDate" id="endDate" name="endDate"
                                                    ...
                                                    value= {this.state.data.packages && this.state.freezeEndDate !== "NaN-NaN-NaN"? this.state.freezeEndDate :"End Date"}
                                        ...
                                        <Row className="form-group mb-3">                                           
                                            <Col>
                                                <Control.textarea model=".freezeReason" id="freezeReason" name="freezeReason"
